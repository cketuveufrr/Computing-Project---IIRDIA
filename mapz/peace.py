...
class OdomImuCorrectorNode:
    def __init__(self):
        ...
        # Topics & frames
        self.imu_topic      = rospy.get_param('~imu_topic',      '/rvr/imu')
        self.odom_topic     = rospy.get_param('~odom_topic',     '/rvr/odom')
        self.corrected_topic= rospy.get_param('~corrected_topic','/rvr/odom_corrected')
