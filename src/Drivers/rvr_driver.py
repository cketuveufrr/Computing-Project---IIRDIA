...
class RobotDriver(DriverLogger):
    ...
    def cmd_vel_callback(self, msg: Twist):
        # simple diff-drive, idem
        L = 0.15
        left  = msg.linear.x - msg.angular.z * L/2
        right = msg.linear.x + msg.angular.z * L/2
        self.speed_params['left_velocity']  = left
        self.speed_params['right_velocity'] = right
