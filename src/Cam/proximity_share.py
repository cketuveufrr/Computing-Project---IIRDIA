...
# ----- CONFIGURATION ----- #
THRESHOLD = 1.0  # en mètres, arbitraire, à ajuster selon les besoins

# Charge les paramètres du JSON généré par DepthAI [vient du taff de Said]
def load_config(fn):
    d = json.load(open(fn))
...
class SwarmMapSharer:
    ...
    def spin(self):
        rate = rospy.Rate(20) #rate quelconque
